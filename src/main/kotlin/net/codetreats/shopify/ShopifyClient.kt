...
class ShopifyClient(
        ...
        inline fun <reified T> getElement(
                ...
                return map[resourceKey]
                        ?: throw IllegalStateException(
                                "Resource key '$resourceKey' not found in response"
                        )
        }
        ...
        inline fun <reified T, reified R> postElement(
                resourceKey: String,
                subUrl: String,
                body: R,
                params: Map<String, String?> = emptyMap(),
        ...
        inline fun <reified T> get(
                ...
                val pageSize =
                        requestedLimit?.let { min(requestedLimit, MAX_PAGE_SIZE) } ?: MAX_PAGE_SIZE
                ...
                while (true) {
                        logger?.info(
                                "GET $currentUrl${currentParams.asUrl()} (${headers.asList()})"
                        )
