...
data class Product(
    ...
    @Json(name = "published_at") val publishedAt: LocalDateTime?,
    @Json(name = "template_suffix") val templateSuffix: String?,
    @Json(name = "status") val status: String?,
    @Json(name = "published_scope") val publishedScope: String?,
    @Json(name = "tags") val tags: String?,
    @Json(name = "admin_graphql_api_id") val adminGraphqlApiId: String?,
    @Json(name = "variants") val variants: List<ProductVariant>?,
    @Json(name = "options") val options: List<ProductOption>?,
