...
data class LineItem(
    ...
    @Json(name = "total_discount_set")
    val totalDiscountSet: MoneySet?,
    @Json(name = "variant_id")
    val variantId: Long?,
    @Json(name = "variant_inventory_management")
    val variantInventoryManagement: String?,
    @Json(name = "variant_title")
    ...
    @Json(name = "tip")
    val tip: Tip?,
    @Json(name = "tip_payment_gateway")
    val tipPaymentGateway: String?,
    @Json(name = "tip_payment_method")
    val tipPaymentMethod: String?
)
